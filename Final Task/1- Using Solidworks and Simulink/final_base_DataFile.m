...
smiData.RigidTransform(1).translation = [74.803149606299215 0 0];  % in
...
smiData.RevoluteJoint(1).ID = '[brdge-1:-:target-1]';

smiData.RevoluteJoint(2).Rz.Pos = 0;  % deg
smiData.RevoluteJoint(2).ID = '[brdge-1:-:groundzero-2]';
